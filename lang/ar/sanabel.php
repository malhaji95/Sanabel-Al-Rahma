...
return [
    ...
    'beneficiary' => [
        ...
        'previous_aid' => 'المساعدات السابقة',
        'previous_aid_help' => 'ما تلقّته الأسرة من جهات أخرى أو قبل تسجيلها. للتوثيق فقط؛ لا يدخل في الاحتساب.',
    ...
    'campaign' => [
        ...
        'complete' => 'إغلاق الحملة',
        'complete_help' => 'لا تُغلق الحملة إلا بعد تنفيذ المساعدة وإثبات وصولها.',
        'remaining' => 'المتبقي',
    ],
    'campaign_status' => [
    ...
    'public' => [
        ...
        'about' => 'من نحن',
        'theme_toggle' => 'تبديل مظهر الواجهة',
        'theme_dark' => 'التبديل إلى الوضع الداكن',
        'theme_light' => 'التبديل إلى الوضع الفاتح',
        'hero_title' => 'عطاءٌ ينمو… وأثرٌ يبقى',
        'hero_body' => 'نُسجّل الأسرة ميدانياً، ونقيّم حاجتها وفق معايير موثّقة، ثم نعرضها للتبرع دون كشف هويتها — ولا يُغلق الملف إلا بإثبات تسليم.',
        'stat_families' => 'أسرة منشورة',
        'stat_regions' => 'منطقة',
        'stat_covered' => 'أسرة مكتملة التغطية',
        'support_campaign' => 'ادعم الحملة',
        'how_title' => 'كيف تصل مساهمتك',
        'how_1_title' => 'تسجيل وزيارة ميدانية',
        'how_1_body' => 'يزور المندوب الأسرة ويوثّق وضعها، حتى دون اتصال بالإنترنت.',
        'how_2_title' => 'تقييم واعتماد',
        'how_2_body' => 'يحتسب النظام الحاجة الشهرية وفق قيم مرجعية معتمدة، ثم تُعتمد الحالة.',
        'how_3_title' => 'تبرع محمي الخصوصية',
        'how_3_body' => 'تظهر الحالة للمتبرع برقم ملف ومنطقة فقط، دون أي بيانات تعرّف بالأسرة.',
        'how_4_title' => 'تحقق وإثبات تسليم',
        'how_4_body' => 'تتحدث التغطية بعد التحقق من الحوالة، ولا يُغلق الملف إلا بإثبات وصول المساعدة.',
        'privacy_note' => 'لا تُعرض على المتبرعين أسماء أو أرقام وطنية أو هواتف أو عناوين. تُعرض الحالة برقم ملف ومنطقة وشرائح فقط.',
        'view_all' => 'عرض الكل',
        'basket_count' => ':count أسرة في السلة',
        'basket_empty_help' => 'اختر الأسر التي ترغب بدعمها من صفحة الحالات، ثم احجز السلة لإتمام الحوالة.',
        'no_donations_help' => 'ستظهر هنا تبرعاتك وحالتها بعد التحقق من الإدارة.',
        'support_this_family' => 'ادعم هذه الأسرة',
        'urgent_first' => 'الأكثر إلحاحاً',
